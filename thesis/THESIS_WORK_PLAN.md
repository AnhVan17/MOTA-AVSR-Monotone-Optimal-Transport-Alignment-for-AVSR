...
- Chạy ablation study trên **ViCocktail subset** (≤ 5K mẫu để tiết kiệm GPU)
...
CHƯƠNG 5. KẾT QUẢ VÀ THẢO LUẬN                        (12-15 trang)
   ...
   5.2. Ablation Study (trên ViCocktail subset)       (3-4 trang)
...
| 5.2 Ablation ViCocktail subset | 3-4   | A           | A chạy ablation                      |
...
**Người A — Ablation trên ViCocktail subset (~5K mẫu, chạy song song với Sprint 3):**
| Ablation | Mô tả |
|---|---|
| A0 | Full model |
...
| Modal credit hết                     | Trung bình | Cao        | Giảm ablation về ≤ 5 cấu hình trên ViCocktail subset 3-5K; main runs chỉ 1-2 lần |
...
- Chỉ chạy main experiments trên ViCocktail, bỏ hoàn toàn ablation.
